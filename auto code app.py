...
st.caption("Validates brand presence using exact matching on a seed dataset.")
...
if uploaded_file:
    try:
        ...
        if start_btn:
            ...
            st.header("3. Results")
            st.markdown("status is 'Yes' if a unique website or logo was found (exact match only).")
